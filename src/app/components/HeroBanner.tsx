    ...
    <div className="mx-auto max-w-9xl px-4 sm:px-6 lg:px-8">
      <div className="mt-24 grid grid-cols-1 items-center gap-14 sm:mt-32 lg:mt-40 lg:grid-cols-2">
        <div className="mx-auto flex max-w-3xl flex-col gap-5">
          <span className="text-3xl font-medium text-black underline">
            Streamer Spotlight
          </span>
          ...
          <div className="flex flex-row justify-center mx-auto align-middle gap-3">
            <div className="text-md text-center rounded-xl bg-slate-400 text-white p-1.5">
              Sports
            </div>
            <div className="text-md text-center  rounded-xl bg-slate-400 text-white p-1.5">
              FIFA
          ...
          <div className="flex  mx-auto space-x-8">
            <a className="bg-purple-500 hover:bg-purple-600 text-lg cursor-pointer text-white px-4 py-2 rounded-lg">
              Subscribe
            </a>

            <a className="bg-blue-500 hover:bg-blue-300 text-lg text-white px-4 py-2 rounded-lg">
              Follow
            </a>
          </div>
        </div>
